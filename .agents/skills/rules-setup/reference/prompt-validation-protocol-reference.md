# Prompt Validation Protocol Reference

**Complete reference for the Prompt Validation Protocol.**

This document contains the full Prompt Validation Protocol for embedding in generated AGENTS.md files or for detailed reference. For installation into a project, use the **prompt-validation-setup** skill which places the protocol in `docs/protocols/PROMPT-VALIDATION-PROTOCOL.md`.
