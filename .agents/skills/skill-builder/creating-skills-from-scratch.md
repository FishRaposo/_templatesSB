...
```bash
# Choose your platform location (e.g. examples/ or _examples/ per project convention)
...
- → **Code quality / structure**: e.g. a code-organization or refactoring skill in the project when available
