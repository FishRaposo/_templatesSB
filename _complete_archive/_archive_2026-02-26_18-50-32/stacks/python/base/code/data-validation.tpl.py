...
#!/usr/bin/env python3
"""
Python Data Validation Template
Purpose: Reusable data validation utilities for Python projects
...
class ValidationError(Exception):
    ...
    def __init__(self, message: str, field: str = None, value: Any = None, errors: List[str] = None):
...
class DataValidator:
    ...
    def add_custom_validator(self, name: str, validator_func: Callable[[Any], bool], error_message: str = None):
    ...
    def validate_field(self, field_name: str, value: Any, rules: List[ValidationRule]) -> ValidationResult:
    ...
    def validate_data(self, data: Dict[str, Any], schema: Dict[str, List[ValidationRule]]) -> Dict[str, ValidationResult]:
    ...
    def _validate_rule(self, field_name: str, value: Any, rule: ValidationRule) -> Optional[str]:
        ...
        try:
            if rule.type == ValidationType.REQUIRED:
                ...
                if value and not self._is_valid_json(value):
    ...
    def _is_valid_date(self, date_value: Union[str, date]) -> bool:
    ...
    def _is_valid_datetime(self, datetime_value: Union[str, datetime]) -> bool:
    ...
    def _is_valid_json(self, json_value: Union[str, Dict, List]) -> bool:
...
def create_user_schema() -> Dict[str, List[ValidationRule]]:
...
def create_api_request_schema() -> Dict[str, List[ValidationRule]]:
...
def sanitize_string(value: str, allow_spaces: bool = True, allow_special: bool = False) -> str:
