...
## Purpose
Plans, subscriptions, metered billing, webhooks handling, invoices.

## Features
- **Core Functionality**: Plans, subscriptions, metered billing, webhooks handling, invoices.
...
const result = await billingstripeService.execute(input);
```
...
**All Supported Stacks**: node, python

## Tier Recommendations
- **basic-billing**: core
- **enterprise-billing**: full
...
## Configuration
The task uses configuration from `config/billing-stripe.yaml`:
