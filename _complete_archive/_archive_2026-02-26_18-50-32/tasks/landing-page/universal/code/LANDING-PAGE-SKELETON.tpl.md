<!--
File: LANDING-PAGE-SKELETON.tpl.md
Purpose: Template for landing-page implementation
Template Version: 1.0
-->

# LandingPage Service Skeleton
...
## Interface
```{{EXTENSION}}
// Universal interface for landing-page service
...
- `{{TASK_NAME}}`: Task name (landing-page)
- `{{STACK}}`: Target stack
- `{{TIER}}`: Target tier
- `{{EXTENSION}}`: File extension for target stack

## Configuration
The service expects configuration in `config/landing-page.yaml`:
