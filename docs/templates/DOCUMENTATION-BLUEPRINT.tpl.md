...
**Purpose**: Canonical documentation baseline for projects generated by the Universal Template System.

**Last Updated**: [CURRENT_DATE]  
**Blueprint Version**: [BLUEPRINT_VERSION]  
**Project Type**: [PROJECT_TYPE]

**Source of Truth**: This blueprint must match the `default-project` blueprint templates in `blueprints/default-project/overlays/generic/`.
...
## 📋 Default-Project Documentation Baseline
...
### 📁 Required docs/ Governance

- `docs/PROMPT-VALIDATION.md`
- `docs/PROMPT-VALIDATION-QUICK.md`
- `docs/DOCUMENTATION-MAINTENANCE.md`
- `docs/TOOL-CALL-LIMITS.md`

### 🧩 Required GitHub Community Health
...
#### 5. **WORKFLOW.md** - User Workflows & Navigation Paths
...
├── WORKFLOW.md                  # User workflows & navigation paths
