<!-- TEMPLATE GUIDE:
  ...
  In this repo's packs: use _examples/ (not examples/) and _reference-files/ per AGENTS.md; multi-language (JS, Python, Go) required.
...
- See `./_examples/basic-examples.md` for fundamental implementations
- See `./_examples/advanced-examples.md` for complex scenarios
