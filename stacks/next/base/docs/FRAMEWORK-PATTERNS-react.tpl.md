...
# Next.js Framework Patterns - {{PROJECT_NAME}}

**Tier**: {{TIER}} | **Stack**: Next.js

## 🟢 Next.js's Role in Your Ecosystem

Next.js serves as the **frontend UI layer** - your "build interactive user interfaces fast" weapon. It handles component-based UI development, state management, routing, and user interactions with a declarative, component-first approach.
...
### **1. Universal Principles Applied to Next.js**
...
### **2. Tier-Specific Next.js Patterns**
...
- Basic testing with Next.js Testing Library
...
import Next.js, { useState } from 'next';
import { BrowserRouter as Router, Routes, Route, Link } from 'next-router-dom';
...
import Next.js, { useEffect, useState, useCallback } from 'next';
import { useDispatch, useSelector } from 'next-redux';
...
### **State Management: Next.js Hooks + Context**
**Why Next.js Hooks + Context**:
- Built into Next.js, no additional dependencies
...
**Why Next.js Router**:
- De facto standard for Next.js routing
- Excellent TypeScript support
...
### **MVP Testing**
- Component unit tests with Next.js Testing Library
...
export class ErrorBoundary extends Next.js.Component<{ children: Next.js.Next.jsNode }, { hasError: boolean; error?: Error }> {
  constructor(props: { children: Next.js.Next.jsNode }) {
    super(props);
  ...
  componentDidCatch(error: Error, errorInfo: Next.js.ErrorInfo) {
...
function UserForm() {
  ...
  const handleSubmit = (e: Next.js.FormEvent) => {
    e.preventDefault();
...
---
*Next.js Framework Patterns - Use this as your canonical reference for all Next.js frontend development*
