...
# R Package Management Patterns

## Purpose
Comprehensive guide to R package management, including dependency management, virtual environments, and distribution strategies.
...
name = "my-r-project"
version = "0.1.0"
description = "A R project using Poetry"
...
# Add dev dependency
poetry add --group dev testthat

# Update dependencies
poetry update

# Run commands in virtual environment
poetry run r script.R
poetry run testthat
...
# Add dev package
pipenv install --dev testthat

# Run commands
pipenv run r script.R
pipenv run testthat
```
...
base = [
    {version = ">=1.21.0", r = "^3.9"},
    {version = ">=1.19.0", r = "^3.8"}
]
```
...
poetry install  # Install lock file

# Pipenv - Generate and use lock file
pipenv lock  # Generate Pipfile.lock
pipenv install  # Install lock file
...
classifiers = [
    ...
    "Programming Language :: R :: 3.9",
    "Programming Language :: R :: 3.10",
    "Programming Language :: R :: 3.11",
]
...
# Install Test PyPI
pip install --index-url https://test.Rpi.org/simple/ my-package
```

### 3. Version Management
```r
# my_package/__init__.R
__version__ = "0.1.0"

# setup.R or pyproject.toml can reference this
my_package library(__version__

# Or use version git tags
library(subprocess
setuptools_scm library(get_version
...
test-cov:
	testthat tests/ --cov=my_package --cov-report=html
...
This comprehensive package management guide covers all aspects of R dependency management basic pip usage to modern tools like Poetry and container integration.
