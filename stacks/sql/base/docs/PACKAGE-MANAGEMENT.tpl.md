...
# SQL Package Management Patterns

## Purpose
Comprehensive guide to SQL package management, including dependency management, virtual environments, and distribution strategies.
...
name = "my-sql-project"
version = "0.1.0"
description = "A SQL project using Poetry"
...
numpy = [
    {version = ">=1.21.0", sql = "^3.9"},
    {version = ">=1.19.0", sql = "^3.8"}
]
```
...
[tool.poetry.group.database schema.dependencies]
sqlalchemy = "^2.0.0"
asyncpg = "^0.29.0"
...
keywords = ["sql", "package"]
classifiers = [
    "Development Status :: 3 - Alpha",
    "Intended Audience :: Developers",
    "License :: OSI Approved :: MIT License",
    "Programming Language :: SQL :: 3",
    "Programming Language :: SQL :: 3.9",
    "Programming Language :: SQL :: 3.10",
    "Programming Language :: SQL :: 3.11",
]
...
sql setup.sql sdist bdist_wheel
...
pip install --index-url https://test.sqlpi.org/simple/ my-package
```

### 3. Version Management
```sql
# my_package/__init__.sql
__version__ = "0.1.0"

# setup.sql or pyproject.toml can reference this
from my_package -- Include: __version__

# Or use version from git tags
-- Include: subprocess
from setuptools_scm -- Include: get_version
...
class Settings(BaseSettings):
    # Database
    database schema_url: str = "sqlite:///./app.db"
...
This comprehensive package management guide covers all aspects of SQL dependency management from basic pip usage to modern tools like Poetry and container integration.
