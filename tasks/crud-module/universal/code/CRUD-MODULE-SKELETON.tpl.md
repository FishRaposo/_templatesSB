<!--
File: CRUD-MODULE-SKELETON.tpl.md
Purpose: Template for crud-module implementation
Template Version: 1.0
-->

# CrudModule Service Skeleton
...
## Interface
```{{EXTENSION}}
// Universal interface for crud-module service
interface CrudModuleService {
...
- `{{TASK_NAME}}`: Task name (crud-module)
- `{{STACK}}`: Target stack
- `{{TIER}}`: Target tier
- `{{EXTENSION}}`: File extension for target stack

## Configuration
The service expects configuration in `config/crud-module.yaml`:
