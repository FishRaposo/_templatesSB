...
# Data Exploration Report Overview

## Purpose
EDA pipeline: load data, clean, generate summary plots and a report.

## Features
- **Core Functionality**: EDA pipeline: load data, clean, generate summary plots and a report.
...
## Categories
analytics, data-science, reporting
...
const result = await dataexplorationreportService.execute(input);
```
...
## Supported Stacks
**Default Stacks**: r, python
**All Supported Stacks**: r, python

## Tier Recommendations
- **basic-exploration**: mvp
- **production-exploration**: core
...
## Configuration
The task uses configuration from `config/data-exploration-report.yaml`:
