...
## Purpose
Marketing page with sections, CTAs, analytics hooks, A/B test ready.

## Features
- **Core Functionality**: Marketing page with sections, CTAs, analytics hooks, A/B test ready.
...
const result = await landingpageService.execute(input);
```
...
**All Supported Stacks**: nextjs, react, flutter

## Tier Recommendations
- **single-page**: mvp
- **conversion-optimized**: core
- **ab-testing-ready**: full
...
## Configuration
The task uses configuration from `config/landing-page.yaml`:
