...
## Features
- **Core Functionality**: Unified notifications: email, push, in-app, with preferences.
...
## Categories
communication, notifications, integration
...
const result = await notificationcenterService.execute(input);
```
...
**All Supported Stacks**: node, python, react, flutter

## Tier Recommendations
- **basic-notifications**: core
- **enterprise-notifications**: full
...
## Configuration
The task uses configuration from `config/notification-center.yaml`:
