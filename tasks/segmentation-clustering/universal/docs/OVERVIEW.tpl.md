...
# Segmentation Clustering Overview

## Purpose
Cluster users/keywords/products/content into segments.

## Features
- **Core Functionality**: Cluster users/keywords/products/content into segments.
...
const result = await segmentationclusteringService.execute(input);
```
...
**All Supported Stacks**: python, r

## Tier Recommendations
- **basic-clustering**: core
- **enterprise-clustering**: full
...
## Configuration
The task uses configuration from `config/segmentation-clustering.yaml`:
