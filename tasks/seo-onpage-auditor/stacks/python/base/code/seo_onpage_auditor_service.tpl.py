...
class SeoOnpageAuditorService:
    """SeoOnpageAuditor service implementation for {{PROJECT_NAME}}."""
    ...
    async def execute(self, input_data: dict) -> dict:
        """Execute the seo-onpage-auditor service.
        ...
        """
        # TODO: Implement seo-onpage-auditor logic here
    ...
    async def get_status(self) -> dict:
        ...
        return {
            "status": "healthy",
            "service": "{{PROJECT_NAME}}-seo-onpage-auditor",
