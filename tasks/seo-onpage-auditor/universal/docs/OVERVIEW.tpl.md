...
# Seo Onpage Auditor Overview

## Purpose
Analyze title/meta/H1/content, lighthouse-like scores, structured suggestions.

## Features
- **Core Functionality**: Analyze title/meta/H1/content, lighthouse-like scores, structured suggestions.
...
const result = await seoonpageauditorService.execute(input);
```
...
**All Supported Stacks**: python, nextjs, react
...
## Configuration
The task uses configuration from `config/seo-onpage-auditor.yaml`:
