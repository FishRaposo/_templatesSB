...
# Seo Rank Tracker Overview

## Purpose
Track keyword rankings over time per domain, visualize trends.

## Features
- **Core Functionality**: Track keyword rankings over time per domain, visualize trends.
...
const result = await seoranktrackerService.execute(input);
```
...
**All Supported Stacks**: python, go, sql, r, nextjs

## Tier Recommendations
- **basic-tracking**: core
- **enterprise-tracking**: full
...
## Configuration
The task uses configuration from `config/seo-rank-tracker.yaml`:
