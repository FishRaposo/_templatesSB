...
## Purpose
Organizations, roles, invitations, member permissions.

## Features
- **Core Functionality**: Organizations, roles, invitations, member permissions.
...
const result = await teamworkspacesService.execute(input);
```
...
## Supported Stacks
**Default Stacks**: node
**All Supported Stacks**: node, react, nextjs

## Tier Recommendations
- **basic-teams**: core
- **enterprise-teams**: full
...
## Configuration
The task uses configuration from `config/team-workspaces.yaml`:
