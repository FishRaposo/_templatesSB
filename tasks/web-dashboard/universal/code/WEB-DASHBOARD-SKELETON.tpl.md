<!--
File: WEB-DASHBOARD-SKELETON.tpl.md
Purpose: Template for web-dashboard implementation
Template Version: 1.0
-->

# WebDashboard Service Skeleton
...
## Interface
```{{EXTENSION}}
// Universal interface for web-dashboard service
...
- `{{TASK_NAME}}`: Task name (web-dashboard)
- `{{STACK}}`: Target stack
- `{{TIER}}`: Target tier
- `{{EXTENSION}}`: File extension for target stack

## Configuration
The service expects configuration in `config/web-dashboard.yaml`:
