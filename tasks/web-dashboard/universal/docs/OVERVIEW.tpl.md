...
## Purpose
Admin or analytics dashboard with cards, filters, charts, tables.

## Features
- **Core Functionality**: Admin or analytics dashboard with cards, filters, charts, tables.
...
const result = await webdashboardService.execute(input);
```
...
**All Supported Stacks**: react, nextjs, flutter

## Tier Recommendations
- **static-dashboard**: mvp
- **live-dashboard**: core
- **enterprise-dashboard**: full
...
## Configuration
The task uses configuration from `config/web-dashboard.yaml`:
