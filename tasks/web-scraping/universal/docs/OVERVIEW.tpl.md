...
## Features
- **Core Functionality**: Scrape pages, parse HTML/JSON, respect robots, store results.
...
const result = await webscrapingService.execute(input);
```
...
**All Supported Stacks**: python, go, node, r, sql

## Tier Recommendations
- **single-site**: mvp
- **multi-site**: core
- **enterprise-crawler**: full
...
## Configuration
The task uses configuration from `config/web-scraping.yaml`:
