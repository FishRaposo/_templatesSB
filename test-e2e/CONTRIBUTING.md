...
1. **Search existing issues** at https://github.com/user/test/issues before opening a new one
...
Open a discussion at https://github.com/user/test/discussions or check existing documentation.
