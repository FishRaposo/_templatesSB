...
- **GitHub Security Advisories**: https://github.com/user/test/security/advisories
...
| Public disclosure | After fix is released and 7 days have passed |
...
_Security events in `CHANGELOG.md` use tag `security` and type `fix`._
